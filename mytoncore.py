...
class LiteClient:
	def __init__(self):
		self.appPath = "/usr/bin/ton/lite-client/lite-client"
		self.configPath = "/usr/bin/ton/lite-client/ton-lite-client-test1.config.json"
		self.pubkeyPath = "/usr/bin/ton/lite-client/server.pub"
		self.addr = "146.0.79.15:29053"
		self.ton = None # magic
	#end define
